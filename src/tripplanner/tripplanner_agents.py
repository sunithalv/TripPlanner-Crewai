...
from src.tripplanner.tools.browser_tools import BrowserTools
from src.tripplanner.tools.calculator_tools import CalculatorTools
from src.tripplanner.tools.search_tools import SearchTools
#from langchain_groq import ChatGroq

class TripAgents():
    def __init__(self, llm: BaseChatModel = None):
        if llm is None:
            #self.llm = LLM(model="groq/qwen-2.5-32b", max_tokens=400)
